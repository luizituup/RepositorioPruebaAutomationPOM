...
public class NotificationsConfirmationReadRun extends setUp{
    ...
    @Test
    public void notificationsConfirmationRead() {
        PageBase app = new PageBase(this.driver);
        app.textCedula("11441862", 10);
        app.clickById("btn_update_document_number", 2);
        app.clickById("btn_dialog_cancel", 25);
        app.clickById("notificationInboxFragment", 10);
        app.clickById("notificationInboxFragment", 5);
