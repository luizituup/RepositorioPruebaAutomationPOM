...
public class Restore_Backup extends setUp {
    ...
    public void ShareNotification(){
        ...
        app.clickById("btn_update_document_number", 5);
        app.clickById("btn_ok", 20);
        app.clickById("notificationInboxFragment", 20);
        ...
        app.clickById("action_toolbar_share", 5);
        app.clickById("btn_dialog_ok", 5);
        app.clickById("button2", 5);
    }
